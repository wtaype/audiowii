const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/login-BjzRLzH7.js","assets/main-BSVaXJIz.js","assets/firebase-Dwbr9bu1.js","assets/login-pzxUIRzl.css"])))=>i.map(i=>d[i]);
import{M as l,$ as s,e as n,r as c,_ as e}from"./main-BSVaXJIz.js";const r=a=>{l?.("Bienvenido "+a.nombre),s(".nv_right").html(`
  ...
  `)};n.on(a=>a?r(a):(o(),c.navigate("/")));const t=n.user;t?r(t):o();const p=["wiTema","wiSmart","wiFresh"];s(document).on("click",".bt_salir",async()=>{const{salir:a}=await e(async()=>{const{salir:i}=await import("./login-BjzRLzH7.js");return{salir:i}},__vite__mapDeps([0,1,2,3]));a(p)});s(document).on("click",".bt_auth",async function(){const{abrirLogin:a}=await e(async()=>{const{abrirLogin:i}=await import("./login-BjzRLzH7.js");return{abrirLogin:i}},__vite__mapDeps([0,1,2,3]));a(s(this).hasClass("registrar")?"registrar":"login")});export{r as personal};
