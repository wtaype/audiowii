  ...
  <div class="wi_inicio">
    <section class="inicio_hero">
      ...
      <div class="inicio_hero_content">
        ...
        <div class="inicio_hero_version">${n} ${u} • ${d}</div>
      ...
      <div class="inicio_hero_visual">
        <div class="inicio_img_container">
          ...
          <img src="/audiowii/hero.webp" alt="${n} - Plataforma de Audio" class="inicio_hero_img" loading="eager">
    ...
    <section class="inicio_features">
      <div class="inicio_section_header">
        <h2 class="inicio_section_title">¿Por qué elegir ${n} para tu audio?</h2>
    ...
    <section class="inicio_testimonials">
      <div class="inicio_section_header">
        ...
        <p class="inicio_section_subtitle">Historias reales de audiófilos que confían en ${n}</p>
        <div class="inicio_section_line"></div>
      </div>
    ...
    <section class="inicio_stats_section">
      <div class="inicio_stats_content">
        <h2 class="inicio_stats_title">${n} en Números</h2>
    ...
    <section class="inicio_cta_section">
      <div class="inicio_cta_content">
        ...
        <p class="inicio_cta_subtitle">
          Únete a miles de usuarios que ya reproducen, editan, convierten y optimizan sus archivos de audio con ${n}. Sin instalación, sin registro, sin complicaciones. Solo resultados profesionales al instante.
        </p>
...
`,x=()=>{let i=0;const o=e(".inicio_role");setInterval(()=>{o.removeClass("active"),i=(i+1)%o.length,o.eq(i).addClass("active")},2500),l(".inicio_hero_stats",()=>{e(".inicio_hero_stats .inicio_stat_number").each(function(){const s=e(this),a=parseInt(s.data("target"));let t=0;const c=setInterval(()=>{t+=a/60,t>=a?(s.text(a+(a===100?"%":a===320?"kbps":"+")),clearInterval(c)):s.text(Math.floor(t))},25)})}),l(".inicio_stats_section",()=>{e(".inicio_stats_section .inicio_stat_number").each(function(){const s=e(this),a=parseInt(s.data("count")),t=s.text().replace(/[0-9]/g,"");let c=0;const r=setInterval(()=>{c+=a/60,c>=a?(s.text(a+t),clearInterval(r)):s.text(Math.floor(c)+t)},25)})}),l(".inicio_features_grid",()=>e(".inicio_feature_card").each((s,a)=>setTimeout(()=>e(a).addClass("visible"),s*100))),l(".inicio_nav_grid",()=>e(".inicio_nav_card").each((s,a)=>setTimeout(()=>e(a).addClass("visible"),s*100))),l(".inicio_tech_grid",()=>e(".inicio_tech_card").each((s,a)=>setTimeout(()=>e(a).addClass("visible"),s*100))),l(".inicio_testimonials_grid",()=>e(".inicio_testimonial_card").each((s,a)=>setTimeout(()=>e(a).addClass("visible"),s*100))),e(".inicio_floating_icon").on("mouseenter",function(){const s=e(this).data("tooltip"),a=e('<div class="inicio_custom_tooltip"></div>').text(s);e("body").append(a);const t=this.getBoundingClientRect(),c=a.outerWidth(),r=a.outerHeight();a.css({top:t.top-r-12+"px",left:t.left+t.width/2-c/2+"px"}),setTimeout(()=>a.addClass("show"),10)}).on("mouseleave",function(){e(".inicio_custom_tooltip").removeClass("show"),setTimeout(()=>e(".inicio_custom_tooltip").remove(),200)}),document.querySelectorAll(".inicio_particle").forEach(s=>{s.style.animationDelay=`${Math.random()*5}s`,s.style.animationDuration=`${10+Math.random()*10}s`})};export{x as init,y as render};
