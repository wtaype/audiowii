const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/login-CZovnEoV.js","assets/main-CCjbrLLS.js","assets/firebase-Dwbr9bu1.js","assets/login-pzxUIRzl.css"])))=>i.map(i=>d[i]);
import{M as l,$ as s,e as n,r as c,_ as e}from"./main-CCjbrLLS.js";const r=a=>{l?.("Bienvenido "+a.nombre),s(".nv_right").html(`
