import{l as e,b as n,c as t,a as s,v,$ as a}from"./main-DlsaqR2-.js";function r(){const o=new Date;return`
  ...
  `}a("body").append(r());a("head").append('<style>:root{--bgim:url("/audiowii/v11/wpuntos.svg")}body{background: var(--bgim), var(--bg)}</style>');const l=()=>`<div class="movil_divider"></div>${a(".nv_right").html()}`;a("body").append(`<div class="movil_overlay"></div>
