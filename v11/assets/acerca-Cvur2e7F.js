      ...
      <div class="creador_card">
        <div class="creador_visual">
          <div class="creador_avatar">
            <img src="/audiowii/v11/wilder.webp" alt="${d}" class="creador_foto">
          </div>
