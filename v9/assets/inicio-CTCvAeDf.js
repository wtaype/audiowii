    ...
    <section class="inicio_hero">
      ...
      <div class="inicio_hero_visual">
        <div class="inicio_img_container">
          ...
          <img src="/audiowii/v9/hero.webp" alt="${n} - Plataforma de Audio" class="inicio_hero_img" loading="eager">
