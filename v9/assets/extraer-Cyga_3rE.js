import{j as e}from"./vendor-gzd0YkcT.js";import{c as k,N as s}from"./main-BrqkJLbH.js";import"./main-cJeOPTY6.js";import"./firebase-BVkF6YOI.js";const M=()=>`
...
`;let _=null,x={duration:0},o=null,n=null;const g=(a=0)=>`${String(Math.floor(a/60)).padStart(2,"0")}:${String(Math.floor(a%60)).padStart(2,"0")}`,f=a=>a?a<1024?`${a.toFixed(2)} B`:a<1024*1024?`${(a/1024).toFixed(2)} KB`:`${(a/(1024*1024)).toFixed(2)} MB`:"0 B",h=a=>{if(!a||!a.type.startsWith("video/"))return s("Por favor selecciona un archivo de video válido","error",2500);_=a;const t=e("#extr_video")[0],i=URL.createObjectURL(a);t.src=i,t.load(),t.onloadedmetadata=()=>{x={name:a.name,duration:t.duration,size:a.size,width:t.videoWidth,height:t.videoHeight},e("#extr_video_name").text(a.name),e("#extr_video_duration").text(g(t.duration)),e("#extr_video_resolution").text(`${t.videoWidth}x${t.videoHeight}`),e("#extr_video_size").text(f(a.size)),e("#extr_end_time").val(t.duration.toFixed(1)),e("#extr_preview_section").removeClass("dpn"),e("#extr_btn_extract").prop("disabled",!1),u(),s(`Video cargado: ${a.name}`,"success",2e3)},t.onerror=()=>{s("Error al cargar el video. Intenta con otro archivo.","error",2500),w()}},w=()=>{const a=e("#extr_video")[0];a.src&&(URL.revokeObjectURL(a.src),a.src=""),_=null,x={name:"",duration:0,size:0,width:0,height:0},e("#extr_preview_section").addClass("dpn"),e("#extr_result_section").addClass("dpn"),e("#extr_btn_extract").prop("disabled",!0),e("#extr_start_time").val(0),e("#extr_end_time").val(0),o&&(URL.revokeObjectURL(o),o=null),n=null},u=()=>{const a=e("#extr_format").val(),t=e("#extr_quality").val(),i=x.duration||0,d={high:320,medium:192,low:128}[t]*1e3/8*i,r={mp3:"MP3",wav:"WAV",ogg:"OGG",m4a:"M4A",aac:"AAC",flac:"FLAC"},c={high:"Alta (320 kbps)",medium:"Media (192 kbps)",low:"Baja (128 kbps)"};e("#extr_preview_format").text(r[a]),e("#extr_preview_quality").text(c[t]),e("#extr_preview_size").text(`~ ${f(d)}`)},z=async()=>{if(!_)return s("No hay video cargado","warning",2e3);const a=e("#extr_format").val(),t=e("#extr_quality").val(),i=e("#extr_sample_rate").val(),m=e("#extr_volume").val(),p=parseFloat(e("#extr_start_time").val())||0,d=parseFloat(e("#extr_end_time").val())||x.duration;if(p>=d)return s("El tiempo de inicio debe ser menor al tiempo de fin","error",2500);try{e("#extr_btn_extract").prop("disabled",!0).html('<i class="fas fa-spinner fa-spin"></i> Procesando...'),e("#extr_progress").removeClass("dpn"),l("Iniciando extracción...",0);const r=new FormData;r.append("video",_),r.append("format",a),r.append("quality",t),r.append("sampleRate",i),r.append("volume",m),r.append("startTime",p),r.append("endTime",d),l("Enviando al servidor...",10);const c=await fetch("http://localhost:3000/extract-audio",{method:"POST",body:r});if(!c.ok)throw new Error(`Error del servidor: ${c.statusText}`);l("Procesando video...",50);const v=await c.json();if(!v.success)throw new Error(v.error||"Error desconocido");l("Descargando audio...",80);const A=`http://localhost:3000${v.downloadUrl}`;n=await(await fetch(A)).blob(),l("Finalizando...",95),o&&URL.revokeObjectURL(o),o=URL.createObjectURL(n);const R=e("#extr_result_audio")[0];R.src=o;const b=v.filename||`audio_${Date.now()}.${a}`;e("#extr_result_name").text(b),e("#extr_result_size").text(f(n.size)),e("#extr_result_duration").text(g(d-p)),l("Completado",100),setTimeout(()=>{e("#extr_progress").addClass("dpn"),e("#extr_result_section").removeClass("dpn"),e("#extr_btn_extract").prop("disabled",!1).html('<i class="fas fa-download"></i> Extraer Audio'),s(`✅ Audio extraído exitosamente: ${b}`,"success",3e3)},500)}catch(r){console.error("Error extrayendo audio:",r),e("#extr_progress").addClass("dpn"),e("#extr_btn_extract").prop("disabled",!1).html('<i class="fas fa-download"></i> Extraer Audio'),s(`Error al extraer audio: ${r.message}`,"error",3500)}},l=(a,t)=>{e("#extr_progress_text").text(a),e("#extr_progress_percent").text(`${t}%`),e("#extr_progress_fill").css("width",`${t}%`)},y=()=>{if(!n)return s("No hay audio para descargar","warning",2e3);const a=e("#extr_format").val(),t=`${_.name.replace(/\.[^.]+$/,"")}_audio.${a}`,i=document.createElement("a");i.href=URL.createObjectURL(n),i.download=t,i.click(),URL.revokeObjectURL(i.href),s(`Descargando: ${t}`,"success",2e3)},O=()=>{console.log(`✅ Extraer de ${k} cargado`),e("#extr_btn_select").on("click",()=>e("#extr_file_input").click()),e("#extr_file_input").on("change",function(){this.files[0]&&h(this.files[0])}),e("#extr_btn_clear").on("click",w),e("#extr_dropzone").on("dblclick",()=>e("#extr_file_input").click()).on("dragover",a=>{a.preventDefault(),e("#extr_dropzone").addClass("dragover")}).on("dragleave",()=>{e("#extr_dropzone").removeClass("dragover")}).on("drop",a=>{a.preventDefault(),e("#extr_dropzone").removeClass("dragover");const t=a.originalEvent.dataTransfer.files[0];t&&h(t)}),e("#extr_format").on("change",u),e("#extr_quality").on("change",u),e("#extr_volume").on("input",function(){e("#extr_volume_val").text(`${e(this).val()}%`)}),e("#extr_btn_extract").on("click",z),e("#extr_btn_download").on("click",y)};export{O as init,M as render};
